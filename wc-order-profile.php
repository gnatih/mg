...
<div>
	<table class="lp-list-table profile-list-orders profile-list-table">
		<thead>
			<tr class="order-row">
				<th class="column-order-number"><?php esc_html_e('Order', 'learnpress-woo-payment'); ?>
				</th>
				<th class="column-order-total"><?php esc_html_e('Total', 'learnpress-woo-payment'); ?>
				</th>
				<th class="column-order-status"><?php esc_html_e('Status', 'learnpress-woo-payment'); ?>
				</th>
				<th class="column-order-date"><?php esc_html_e('Date', 'learnpress-woo-payment'); ?>
				</th>
			</tr>
		</thead>
		...
		<tfoot>
			<tr class="list-table-nav">
				<td colspan="2" class="nav-text"><?php echo $output_format_text; ?>
				</td>
