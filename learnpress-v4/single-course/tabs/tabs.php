...
<div id="learn-press-course-tabs" class="course-tabs">
	...
	<ul class="nav nav-tabs">
		...
		<?php
            ...
            ?>
		<li role="presentation" class="<?php echo implode(' ', $classes); ?>">
	...
	<div class="tab-content">
		...
		<div class="tab-pane course-tab-panel-<?php echo esc_attr($key); ?> course-tab-panel<?php echo ! empty($tab['active']) && $tab['active'] ? ' active' : ''; ?>" id="<?php echo esc_attr($tab['id']); ?>">
			<?php
